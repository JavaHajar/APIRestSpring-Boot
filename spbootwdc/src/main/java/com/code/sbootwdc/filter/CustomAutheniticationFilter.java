package com.code.sbootwdc.filter;
...
@Slf4j
public class CustomAutheniticationFilter extends UsernamePasswordAuthenticationFilter {
    private  final AuthenticationManager authenticationManager;
    public CustomAutheniticationFilter(AuthenticationManager authenticationManager){
